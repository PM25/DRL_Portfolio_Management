...
class Actor(nn.Module):
    def __init__(self, features_sz, actions_sz):
        super().__init__()
        self.input_layer = nn.Linear(in_features=features_sz, out_features=128)
        ...
        self.out = nn.Linear(in_features=16, out_features=actions_sz)
